...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.17.0)", date = "2025-11-24")
public class InternalLeadDto implements org.apache.thrift.TBase<InternalLeadDto, InternalLeadDto._Fields>, java.io.Serializable, Cloneable, Comparable<InternalLeadDto> {
  ...
  public int compareTo(InternalLeadDto other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetLastNamefirstName(), other.isSetLastNamefirstName());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetLastNamefirstName()) {
